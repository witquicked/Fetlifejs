...
export declare class FetlifeRepository implements IFetlifeRepository {
    private clientId;
    ...
    uploadPicture(tokenType: string, accessToken: string, picture: any, isAvatar: boolean, friendsOnly: boolean, caption: string, isFromUser: boolean): Promise<any>;
}
